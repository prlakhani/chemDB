...
def start(request, template="excel/start.html", extra_context=None):
...
def import_object(request, template="excel/import_object.html", extra_context=None, \
					   return_action=start):
	if extra_context is None:
		extra_context = {}
...
def import_relation(request, template="excel/import_relation.html", extra_context=None, \
					   return_action=start):
	if extra_context is None:
		extra_context = {}
	if request.method == 'POST':
